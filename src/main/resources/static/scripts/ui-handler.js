...
$(document).ready(function() {
  ...
  function messageHandler(sMessage) {
    ...
    updateChatArea("myFriend: " + sMessage);
  ...
  $("#buttonSend").click(function() {
    ...
    updateChatAreaBottom("Chitra: " + sChatText);
  ...
  function updateChatAreaBottom(sText) {
	    var sCurrentText = $("#chatAreaBottom").val() + "\n" + sText;
	    $("#chatAreaBottom").val(sCurrentText);
	  }
